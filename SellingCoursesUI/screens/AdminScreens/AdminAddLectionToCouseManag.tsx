...
import AdminLectionListInCourse from "./AdminLectionListInCourse";
import AdminExistingLection from "./AdminExistingLection";

const AdminAddLectionToCouseManag = () => {
    ...
    return (
        ...
        >
            <Tab.Screen
                ...
                component={AdminLectionListInCourse}
                options={{
                    tabBarLabel: 'Bài học trong khóa học',
                    tabBarIcon: ({ color }) => (
            ...
            <Tab.Screen
                ...
                initialParams={userEmail}
                component={AdminExistingLection}
                options={{
                    tabBarLabel: 'Bài học hiện có',
                    tabBarIcon: ({ color }) => (
...
export default AdminAddLectionToCouseManag